...
void UNeo4jDatabase::QueryStrings(TArray<FString> inStrings, TSharedRef<IHttpRequest, ESPMode::ThreadSafe> httpRequest)
{
...
void UNeo4jDatabase::_SendQuery(FString query, TSharedRef<IHttpRequest, ESPMode::ThreadSafe> httpRequest)
{
